...
<body>
    <div class="container">
        ...
        <form action="functions.php" method="POST" autocomplete="off">
            <input type="text" name="student_number" placeholder="Student number" required value="<?php echo isset($_COOKIE['stud_login_student_number']) ? htmlspecialchars($_COOKIE['stud_login_student_number']) : ''; ?>">
    ...
    window.addEventListener("load", () => {
        ...
        document.cookie = "stud_login_student_number=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
    });
    </script>
