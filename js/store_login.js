document.addEventListener('DOMContentLoaded', function() {
    ...
    const loginError = getCookie("store_login_err");
    ...
    window.addEventListener("load", () => {
        document.cookie = "store_reg_success=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/";
        document.cookie = "store_login_err=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/";
        document.cookie = "store_login_email=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/";
    });
});